# myPlotMedian.general.R
# A generic function to plot median response variable by two factors.
#
...
myPlotMedian.general <- function(response,fact1,fact2,xlab,ylab,legend.lab,cex, 
                                 cex.lab=NULL,ylim=c(0,1000), pch=1:(1+nlevs2), 
	...
	means <- tapply(response,list(fact1,fact2),median)
	...
	par(cex.lab=cex.lab, cex.axis=cex, font.lab=2, mar=c(5,8,3,2), lwd=1)
