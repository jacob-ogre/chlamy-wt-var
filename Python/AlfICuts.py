...
def main():
    ...
    USAGE:
        python AlfICuts.py <infil> <outfil>
    ...
    COMMENTS:
        Uses the re module to compile and search for the regexes 
            '[ACGTN]{12}GCA[ACGTN]{6}TGC[ACGTN]{12}' 
        which corresponds to the AlfI seq. After finding all sites, winnows the 
...
def winnow_to_unique():
    """
    Determine if the sequence at a locus is unique.
...
def compile_re1():
    """Compiles the AlfI regex for + strand."""
